  ...
  <section>
    ...
    <div className="flex flex-col gap-3 text-lg">
      ...
      <p>
        ...
        API·네이티브 브릿지·차량 제어 규격을 Claude Code 스킬로 만들어 AI가 도메인 맥락을 바로 이해하도록 했습니다. JIRA
        티켓을 분석해 근무일지를 자동으로 쓰는 솔루션으로 사내 AI 챌린지 1위와 전사 도입을 이끌었습니다. 아침 JIRA 브리핑,
        메일 초안 검수, 학습 기록 정리처럼 매일 하는 일도 AI로 자동화해 일상 업무 흐름에 자연스럽게 자리 잡게 했습니다.
      </p>
      <p>
        이 밖에도 NAN 2026 AI 게임 해커톤에서 <StrongComponent>588팀 중 3위로 우수상</StrongComponent>을 받았고, CODEGATE 2026 AI
